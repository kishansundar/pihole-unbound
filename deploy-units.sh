...
#   unbound.conf, unbound.service, ulimit.sh
#   roothints.sh, roothints.service, roothints.timer
#   gravity.service, gravity.timer
...
deploy_file unbound.conf /etc/unbound/unbound.conf root:root 644

echo "------------------------------------------"
echo "Deploying unbound.service..."
deploy_file unbound.service /etc/systemd/system/unbound.service root:root 644

echo "------------------------------------------"
echo "Deploying ulimit.sh..."
deploy_file ulimit.sh /etc/unbound/ulimit.sh root:root 755

echo "------------------------------------------"
echo "Deploying roothints.sh, roothints.service, roothints.timer..."
deploy_file roothints.sh /etc/unbound/roothints.sh root:root 755
deploy_file roothints.service /etc/systemd/system/roothints.service root:root 644
deploy_file roothints.timer /etc/systemd/system/roothints.timer root:root 644

echo "------------------------------------------"
echo "Deploying gravity.service, gravity.timer..."
deploy_file gravity.service /etc/systemd/system/gravity.service root:root 644
deploy_file gravity.timer /etc/systemd/system/gravity.timer root:root 644
